...
package MyMotorDriver is
   ...
   type Directions is (Forward, Stop, backwards, left, right, rightUp,leftUp, rightDown, leftDown, turnRight, turnLeft); --only two are implemented but many configuration are possible with mecanum wheels
